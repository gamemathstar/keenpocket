...
<head>
    ...
    <meta name="description" content="VoteAdmin - Bootstrap Admin Dashboard" />
    <meta property="og:title" content="VoteAdmin - Bootstrap Admin Dashboard" />
    <meta property="og:description" content="VoteAdmin - Bootstrap Admin Dashboard" />
    <meta property="og:image" content="https://VoteAdmin.dexignlab.com/xhtml/social-image.png" />
    <meta name="format-detection" content="telephone=no">

    <!-- PAGE TITLE HERE -->
    <title>VoteAdmin - Bootstrap Admin Dashboard</title>
                    ...
                    <ul class="navbar-nav header-right">
                        ...
                        <li class="nav-item dropdown header-profile">
                            <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                <img src="images/profile/pic2.jpg" width="20" alt=""/>
